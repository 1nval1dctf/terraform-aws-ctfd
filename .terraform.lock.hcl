...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "3.59.0"
  constraints = ">= 2.0.0, >= 3.13.0, >= 3.38.0, >= 3.40.0, ~> 3.46, >= 3.56.0, 3.59.0, ~> 3.59, < 4.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/kubernetes" {
  version     = "2.5.0"
  constraints = ">= 1.10.0, >= 1.11.1, ~> 2.3, < 3.0.0"
  hashes = [
